...
const AllNFTs = () => {
  const { walletAddress, getAllNfts } = useWallet();
  ...
  return (
    // <div className="relative min-h-screen overflow-x-hidden pt-24 px-4 bg-gradient-to-tr from-[#0f2027] via-[#203a43] to-[#2c5364] text-white overflow-x-hidden">
    <div className="mt-25">
